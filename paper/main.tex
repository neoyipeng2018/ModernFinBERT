...
\begin{table}[h]
\centering
\caption{Baseline comparison on FPB. In-domain models trained on FPB; ModernBERT and BERT-base trained on 8,643 non-FPB samples. FinBERT-IJCAI agreement level unspecified in original paper.}
\label{tab:baselines}
